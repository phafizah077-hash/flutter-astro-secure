...
class AturScreentimePage extends StatefulWidget {
  const AturScreentimePage({Key? key}) : super(key: key);

  @override
  State<AturScreentimePage> createState() => _AturScreentimePageState();
}

class _AturScreentimePageState extends State<AturScreentimePage>
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        padding: const EdgeInsets.symmetric(
          horizontal: 24,
          vertical: 22,
        ), // Padding sedikit lebih tebal karena 1 baris
        decoration: BoxDecoration(
          color: isSelected
