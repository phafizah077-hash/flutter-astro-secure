...
class KegiatanLevelPage extends StatefulWidget {
  final String levelName;
  final int itemCount;

  // Constructor default untuk Level 1
  const KegiatanLevelPage({
    Key? key,
  ...
  @override
  State<KegiatanLevelPage> createState() => _KegiatanLevelPageState();
}

class _KegiatanLevelPageState extends State<KegiatanLevelPage>
